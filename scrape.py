...
niche = input("Kind of Niche: ")
url = f"https://www.pexels.com/search/videos/{niche}/?orientation=portrait"
video_links = []
...
def download_video_series(video_links):
    songs = int(input('How Many Songs you Have? '))
    i=1
   ...
   # iterate through all links in video_links
    ...
    #obtain filename by splitting url and getting last string
        ...
        #editing the video
        list = random.choice(range(1, songs))
